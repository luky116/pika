...
class PikaServer : public pstd::noncopyable {
 public:
  ...
  //TODO: yuecai
  pstd::Status GetDumpMeta(const std::string& db_name, const uint32_t slot_id, std::map<std::string, std::vector<std::string>>& fileNameTable, std::string& snapshot_uuid);
